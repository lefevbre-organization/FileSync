...
def select_actions_based_on_condition(datetime_condition, list_of_actions_from_log, logname):
...
def LogParser():
    ...
    def parser_log():
        ...
        for logname in glob.glob(path_to_rclone_log_folder):
            ...
            print("\n+++++++++++++ All actions +++++++++++++\n")
            log_actions = select_actions_based_on_condition(datetime_beginning_of_time, list_of_actions_from_log,logname)
