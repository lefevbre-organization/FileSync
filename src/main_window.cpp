...
MainWindow::MainWindow() {
  ...
  if (IsPortableMode()) {
    this->setWindowTitle("Lefebvre File Sync - portable mode - BETA release");
  } else {
    this->setWindowTitle("Lefebvre File Sync - BETA release");
  }
  ...
  darkPalette.setColor(QPalette::WindowText, QColor(0, 25, 120));
  darkPalette.setColor(QPalette::ToolTipBase, QColor(0, 25, 120));
  darkPalette.setColor(QPalette::ToolTipText, QColor(0, 25, 120));
  darkPalette.setColor(QPalette::Text, QColor(0, 25, 120));
  darkPalette.setColor(QPalette::ButtonText, QColor(0, 25, 120));
  ...
  darkPalette.setColor(QPalette::Disabled, QPalette::Background,
      QColor(128, 140, 187));
  ...
  if (darkMode) {
    ...
    QPalette darkPalette;
    darkPalette.setColor(QPalette::Window, QColor(0, 25, 120));
    darkPalette.setColor(QPalette::WindowText, Qt::white);
    darkPalette.setColor(QPalette::Disabled, QPalette::WindowText,
                         QColor(127, 127, 127));
    darkPalette.setColor(QPalette::Base, QColor(0, 25, 120));
    ...
    darkPalette.setColor(QPalette::Button, QColor(0, 25, 120));
